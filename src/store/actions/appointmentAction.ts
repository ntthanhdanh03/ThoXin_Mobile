...
export const getAppointmentByOrderAction = (data: any, callback?: any) => ({
  type: types.GET_APPOINTMENT_BY_ORDER,
  payload: data,
  callback,
});

export const getAppointmentByOrderSuccessAction = (data: any) => ({
  type: types.GET_APPOINTMENT_BY_ORDER + types.SUCCESS,
  payload: data,
});
