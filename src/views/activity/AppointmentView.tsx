...
import { getAppointmentByOrderAction } from '../../store/actions/appointmentAction';
...
const AppointmentView = ({ route }: any) => {
  ...
  useEffect(() => {
    dispatch(
      getAppointmentByOrderAction({ orderId: item?._id }, (data: any) => {
        if (data) {
                  ...
                  <View style={styles.applicantHeader}>
                    <View style={styles.avatarPlaceholder}>
                      <Text style={styles.avatarText}>
                        {order.applicants[0].name.charAt(0).toUpperCase()}
                      </Text>
                    </View>
                    <View style={styles.applicantInfo}>
                      <Text style={styles.applicantName}>
                        {order.applicants[0].name}
                      </Text>
                      {order.applicants[0].note && (
                        <Text style={styles.applicantNote} numberOfLines={1}>
                          {order.applicants[0].note}
                        </Text>
                      )}
                    </View>
                ...
                <View style={styles.section}>
                  ...
                  {appointmentData.additionalIssues.map(
                    (issue: any, issueIndex: number) => (
                      <View key={issue._id} style={styles.additionalIssueCard}>
